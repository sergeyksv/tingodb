...
tdb.prototype.collectionNames = function (opts, cb) {
	...
	var self = this;
	safe.back(cb,null,_(this._cols).keys().map(function (e) { return opts.namesOnly?e:{name:self._name+"."+e};}).value())
}

tdb.prototype.collections = function (cb) {
	safe.back(cb,null, _.values(this._cols))
}
